...
function EmeraldCard() {
    ...
    let price = localStorage.getItem('emerald');
    ...
    let ownedQ = localStorage.getItem('emeraldsOwned');
    ...
    return (
        ...
        <div className="topCard">
            <img className="cardIMG" src={emeraldImg} alt="emerald" width="50px" />
            <div className="topCardDetails">
            <p>
                Emerald <br /> Price: {price}$
            </p>
            </div>
        </div>
