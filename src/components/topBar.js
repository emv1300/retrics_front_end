...
function TopBar(){
    ...
    return(
        <div> 
            <div data-testid = "topBar" className="topNavBar">
                <img
                className="whiteLogo"
                alt="website logo"
                src={whiteLogo}
                ...
                <p data-testid = "userBalance" className="balance"> {accountBalance} $</p>
                ...
                <button data-testid = "logOutBT" className="logoutBT" onClick={Logout}>
